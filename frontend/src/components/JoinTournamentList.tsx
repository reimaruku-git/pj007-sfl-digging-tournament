...
export const JOIN_CARD_CLASS =
  "join-card flex items-start justify-between gap-4 rounded-2xl border border-[rgba(196,184,164,0.14)] bg-dusk-panel p-5 text-inherit no-underline shadow-[0_10px_28px_rgba(0,0,0,0.28)] transition-colors hover:border-[rgba(184,154,86,0.35)]";

export const JOIN_BADGE_ONGOING =
  "join-badge shrink-0 rounded-md bg-green-700 px-2.5 py-1 text-xs font-semibold tracking-wide text-white";

export const JOIN_BADGE_UPCOMING =
  "join-badge shrink-0 rounded-md bg-zinc-500 px-2.5 py-1 text-xs font-semibold tracking-wide text-white";
...
export function JoinTournamentList({
  ...
  return (
    <section className="join-list mt-4" id="join">
      <h2 className="join-head mb-2 text-[11px] font-bold uppercase tracking-[0.14em] text-dusk-gold">
        Join a tournament
      </h2>
      <p className="join-sub mb-4 text-sm leading-relaxed text-dusk-mute">
      ...
      <div className="join-stack flex flex-col gap-3" data-testid="join-tournaments">
          ...
          return (
            ...
            >
              <div className="min-w-0">
                ...
                <div className="join-card-meta mt-1 text-sm text-dusk-mute">
